...
/*float32x4_t cos_mycode(float32x4_t x){
	...
	// switch (quad){
	// case 0: return  cos_mycodes(x);
	// case 1: return -cos_mycodes(DP_PI-x);
	// case 2: return -cos_mycodes(x-DP_PI);
	// case 3: return  cos_mycodes(twopi-x);
	// }
  // return 0.0; 
  
int32x4_t quad = vcvtq_s32_f32(vmulq_f32(x,vdupq_n_f32(two_over_pi)));
...
case0= vaddq_f32(c1,vmulq_f32(vmulq_f32(x,x),c2));
case1= vaddq_f32(c1,vmulq_f32(vmulq_f32((vsubq_f32(vdupq_n_f32(DP_PI),x)),(vsubq_f32(vdupq_n_f32(DP_PI),x))),c2));
case2= vaddq_f32(c1,vmulq_f32(vmulq_f32((vsubq_f32(x,vdupq_n_f32(DP_PI))),(vsubq_f32(x,vdupq_n_f32(DP_PI)))),c2));
case3= vaddq_f32(c1,vmulq_f32(vmulq_f32((vsubq_f32(vdupq_n_f32(twopi),x)),(vsubq_f32(vdupq_n_f32(twopi),x))),c2));
